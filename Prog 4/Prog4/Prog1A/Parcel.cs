...
// File: Parcel.cs
// Parcel serves as the abstract base class of the Parcel hierachy. As well as the addition of an Icomparable that compares it with other parcels.
...
public abstract class Parcel : IComparable<Parcel>
{
    ...
    //precondition: an original parcel has been created
    //postcondition: parcel 2 is compared to the original
    public int CompareTo(Parcel parcel2)
    {

        return CalcCost().CompareTo(parcel2.CalcCost());
    }
}
